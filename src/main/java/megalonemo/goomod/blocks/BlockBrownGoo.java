...
public class BlockBrownGoo extends Block {
    public BlockBrownGoo(Properties properties) {
        super(properties);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.brown_goo.get().create();
    }
        ...
        if(!world.isRemote) {
            for (int i = 0; i < goos.length; i++) {
                if (world.getBlockState(pos.add(1, 0, 0)) == goos[i]) {
                    world.setBlockState(pos.add(1, 0, 0), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(0, 1, 0)) == goos[i]) {
                    world.setBlockState(pos.add(0, 1, 0), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(0, 0, 1)) == goos[i]) {
                    world.setBlockState(pos.add(0, 0, 1), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(0, 0, -1)) == goos[i]) {
                    world.setBlockState(pos.add(0, 0, -1), ModBlocks.brown_goo.getDefaultState());
                }
                ...
                if (world.getBlockState(pos.add(1, 0, 1)) == goos[i]) {
                    world.setBlockState(pos.add(1, 0, 1), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(1, 0, -1)) == goos[i]) {
                    world.setBlockState(pos.add(1, 0, -1), ModBlocks.brown_goo.getDefaultState());
                }
                ...
                if (world.getBlockState(pos.add(1, 1, 0)) == goos[i]) {
                    world.setBlockState(pos.add(1, 1, 0), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(0, 1, 1)) == goos[i]) {
                    world.setBlockState(pos.add(0, 1, 1), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(0, 1, -1)) == goos[i]) {
                    world.setBlockState(pos.add(0, 1, -1), ModBlocks.brown_goo.getDefaultState());
                }
                ...
                if (world.getBlockState(pos.add(1, 1, 1)) == goos[i]) {
                    world.setBlockState(pos.add(1, 1, 1), ModBlocks.brown_goo.getDefaultState());
                }
                if (world.getBlockState(pos.add(1, 1, -1)) == goos[i]) {
                    world.setBlockState(pos.add(1, 1, -1), ModBlocks.brown_goo.getDefaultState());
                }
