...
public class TileEntityTunnlerGoo extends TileEntity implements ITickableTileEntity {
    private int life = 0;

    public TileEntityTunnlerGoo(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public TileEntityTunnlerGoo() {
